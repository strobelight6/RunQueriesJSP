LOAD DATA INFILE '/var/lib/mysql/data/Data/urlused.txt'
...
LOAD DATA INFILE '/var/lib/mysql/data/Data/user.txt'
INTO TABLE users
FIELDS TERMINATED BY ';' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
...
LOAD DATA INFILE '/var/lib/mysql/data/Data/tagged.txt'
INTO TABLE includes
FIELDS TERMINATED BY ';' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
...
LOAD DATA INFILE '/var/lib/mysql/data/Data/mentioned.txt'
...
LOAD DATA INFILE '/var/lib/mysql/data/Data/tweets.txt'
INTO TABLE tweet
FIELDS TERMINATED BY ';' OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
